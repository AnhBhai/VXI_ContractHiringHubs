...
namespace VXIContractHiringHubs
{
    ...
    public static class MercGuildDictionary
    {
        ...
        public static void BuildAllDictionaries()
        {
        ...
        {
            string filePath = Path.Combine(VXIContractHiringHubs.Main.Settings.modDirectory, "ContractBuilding", "Darius_LongDescription.csv");
        ...
        {
            string filePath = Path.Combine(VXIContractHiringHubs.Main.Settings.modDirectory, "ContractBuilding", "Employer_ShortDescription.csv");
        ...
        {
            string filePath = Path.Combine(VXIContractHiringHubs.Main.Settings.modDirectory, "ContractBuilding", "ContractTypeID.csv");
